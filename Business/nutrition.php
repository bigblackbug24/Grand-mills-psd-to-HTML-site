...
<html lang="en">
    <head>
        ...
        <title>Nutrition | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="clear pad-20"></div>
                <div class="col-sm-6">
                    <img style="min-height:450px;max-height: 1250px;" src="images/slider/nutrition.jpg" class="img-responsive">
                </div>
                <div class="col-sm-6">
                    <div class="bg_wht pad-30">
                        <h3 class="mt-0">Nutrition</h3>
