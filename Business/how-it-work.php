...
<html lang="en">
    <head>
        ...
        <title>How It Works | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
	...
	<div class="container">
    	...
    	<div class="collapse navbar-collapse" id="mobile-nav">
        	<ul class="nav navbar-nav">
                ...
                <li class="active"><a href="#">BAKERS' CLUB</a>
                	<ul class="submenu">
...
<div class="clear"></div>
        <div class=" banner"><img src="images/slider/grand-mills-bakers-club.jpg" class=" img-responsive"><h1>Baker's Club</h1></div>
        <div class="clear pad-50"></div>
        
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="bg_wht pad-50">
                <div class="show"><img src="images/bakers-club.png" style="padding-bottom:4px;" class=" img-responsive"></div><br>
                        <h3 class="mt-0">How It Work</h3>
                     
                        <p>Grand Mills’ Bakers' Club is the exclusive loyalty program for our professional customers across the UAE. It’s our special way of rewarding you for your unconditional loyalty and continuous trust in our products.
</p>
                        
                        <p>Your points are valid for one year after a purchase. You can check your points balance online at any time. Every time the balance changes, you will receive an e-mail and SMS notification.
If you have questions, please feel free to contact us on <a href="gmloyalty@agthia.com"><font color="#0000FF">gmloyalty@agthia.com</font></a></p>
                ...
                <div class="col-sm-6">
                    <div class="bg_wht pad-50">
                        ...
                        <p>consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                          ...
                          <p>consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo</p>
                    </div>
                </div>
            </div>
        </div>
