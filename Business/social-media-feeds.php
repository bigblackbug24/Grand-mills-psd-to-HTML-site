...
<html lang="en">
    <head>
        ...
        <title>Social Media Feeds | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class="banner"><img src="images/slider/grand-mills-social-media-feeds.jpg" class=" img-responsive"><h1>Media</h1></div>
        ...
        <div class="container">
            ...
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                ...
                <div class="col-sm-4">
                    ...
                    <iframe src="#" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:350px; height: 350px" ></iframe> </div>
             </div>
                </div>
            </div>
        </div>
