...
<title>Careers | Grand Mills B2B | Abu Dhabi UAE</title>
<!-- Bootstrap core CSS -->
...
<div class="banner"><img src="images/slider/Careers.jpg"><h1>CAREERS</h1></div>
...
<div class="container">
	<div class="row">
        ...
        <div class="col-sm-6">
            <div class="bg_wht pad-20">
            	<h3>Application Form <small class="pull-right text_14 opan mt-5"><font color="#FF0000">*</font> = Madatory Fields</small></h3>
                <form>
                    ...
                    <div class="form-group">
                    	<textarea class="form-control" id="" placeholder="Describe Yourself" rows="5"></textarea>
                    </div>
                    <div class="input-group">                        
                        <input placeholder="Attach your CV with cover letter" class="form-control" type="text">
