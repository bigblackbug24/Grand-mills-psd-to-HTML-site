...
<title>Agri Business Division | Grand Mills B2B | Abu Dhabi UAE</title>
<!-- Bootstrap core CSS -->
	...
	<div class="container">
    	...
    	<div class="collapse navbar-collapse" id="mobile-nav">
        	<ul class="nav navbar-nav">
        		...
        		<li class="active"><a href="grand-mills.php">GRAND MILLS</a>
...
<div class="banner"><img src="images/slider/weat.jpg"><h1>Agthia</h1></div>
<div class="clear pad-20"></div>

<div class="container">
	<div class="row">
    	<div class="col-sm-6">
        	<img src="images/agri.jpg" class="img-responsive">
            <div class="bg_wht pad-20">
            	<h3 class="mt-0">Agri Business Division</h3>
                <p>Agri Business consists of two categories; Flour and Animal Feed. The initial operations of the Grand Mills brand was first established only with flourmills and silos, and subsequently expanded in 1981.</p>
                
                <p>Located in Abu Dhabi,Agri Business is responsible for the management, manufacturing, distribution and marketing of Grand Mills flour, the leading flour in the UAE, and Agrivita animal feed, the leading animal feed in the UAE. </p>
                <p>Our focus is on continued marketing investment aimed at building and consolidating brand equity while driving sales and volume growth, geographic expansion and enhanced profitability.</p>
                <br><br><br><br><br>
            </div>
            <div class="clear pad-15"></div>
        </div>
        <div class="col-sm-6">
        	<img src="images/consumar.jpg" class="img-responsive">
            <div class="bg_wht pad-20">
            	<h3 class="mt-0">Consumer Business Division</h3>
                <p>Consumer Business is responsible for the management, distribution and marketing of several food and beverage brands, which are manufactured in Agthia-owned operations located in Oman, Egypt and Turkey. They include Al Ain Water; a leading bottled drinking water in the UAE, Al Bayan Water, Capri-Sun juices, Al Ain Tomato Paste. They also include frozen vegetable products,  Yoplait dairy products and Alpin Natural Spring bottled water.</p>
                <p>Agthia's well-established high quality local and regional brands combined with newly launched, leading global brands characterize Aghia's attractive product portfolio; one that is trusted by customers and consumers.</p>
                <br><br><br><br>
