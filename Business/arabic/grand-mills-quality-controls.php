...
<html lang="en">
    <head>
        ...
        <title>Quality Controls | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
	...
	<div class="container">
    	...
    	<div class="collapse navbar-collapse" id="mobile-nav">
        	<ul class="nav navbar-nav">
                ...
                <li class="active"><a href="field-to-fork.php">FROM FIELD TO FORK</a>
...
<div class="clear"></div>
		...
		<div class="banner"><img src="images/slider/folk.jpg"><h1>Quality Control</h1></div>
        ...
        <div class="container">
            <div class="row">
                <div class="clear pad-20"></div>
                <div class="col-sm-6">
                    <img style="min-height:450px;max-height: 1250px;" src="images/slider/Certifications-Beyond-Quality_02.jpg" class="img-responsive">
                </div>
                <div class="col-sm-6">
                    <div class="bg_wht pad-30">
                        <h3 class="mt-0">Our Definition of Quality</h3>
                        <p>Grand Mills operates a modern, fully automated manufacturing facility for flour in accordance with the requirements of the local authorities. In our state-of-the-art laboratory, we have the latest analytical equipment, which supports our teams in providing superior flour quality.</p>
                        
                        <p>We focus on Quality Assurance. Our Quality Management System is based on internal and externally recognized quality standards. These include ISO9001:2008, ISO14001:2004, FSSC22000 and ohsas18001:2007 and Hazard Analysis and Critical Control Points (HACCP), a food safety risk assessment process focused on controlling biological, chemical and physical hazards within the food chain.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="foot_menu">
                            ...
                            <li><a href="news.php">News / FAQ</a></li>
                            <li><a href="map-of-exports.php">Sitemap</a></li>                    
