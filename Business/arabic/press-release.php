...
<html lang="en">
    <head>
        ...
        <title>Press Release| Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class="banner"><img src="images/slider/grand-mills-media.jpg" class="img-responsive"><h1>Media</h1></div>
        <div class="clear pad-50"></div>
        
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img style="min-height:250px;max-height: 600px;width:100%;" src="images/slider/Press-Release-Media-content-image.jpg" class="img-responsive">
                </div>
                <div class="col-sm-6">
                    <div class="bg_wht pad-50">
                        <h3 class="mt-0">Press Release</h3>
