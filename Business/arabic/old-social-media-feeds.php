    	...
    	<div class="row">
            ...
            <div class="col-sm-6">
            	<ul class="top_links">
                    ...
                    <li><a href="#"><img src="images/bakersclub.png" width="65"></a></li>
                </ul>
                <div class="clear"></div>
                <ul class="top_social">
	...
	<div class="container">
    	...
    	<div class="collapse navbar-collapse" id="mobile-nav">
        	<ul class="nav navbar-nav">
                ...
                <li><a href="beyond-flour.html">BEYOND FLOUR</a></li>
                	...
                	<ul class="submenu">
                        ...
                        <li>
                        	<div class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="media-heading"><a href="#">B2C Range</a></h5>
                                </div>
                            </div>
                        </li>
                    </ul>
                    	...
                    	<li>
                        	<div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href="grand-mills-nutrition.php">Nutrition</a>
                                </div>
                            </div>
                        </li>
                        <li>
...
<div class="clear"></div>
        ...
        <div class="banner"><img src="images/slider/weat.jpg" class=" img-responsive"><h1>Media</h1></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="bg_wht pad-15">
                        <div style="display: block;border-bottom: 1px solid pink;margin-bottom: 10px;">
                        <a href="#" style="padding-left: 4%;"><i class="fa fa-twitter fa-4x"></i></a>
                        <h3 class="mt-0" style="position: absolute;top: 4%;left: 37%;">Twitter</h3>
                        </div>
                    
            
                                             <a class="twitter-timeline"  href="https://twitter.com/TasawwerHussain" data-widget-id="709007340134072320">Tweets by @TasawwerHussain</a>
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                ...
                <div class="col-sm-4">
                    <div class="bg_wht pad-15">
                    <div style="display: block;border-bottom: 1px solid pink;margin-bottom: 10px;">
                        <a href="#" style="padding-left: 4%;padding-top: 4px;"><i class="fa fa-facebook fa-4x"></i></a>
                        <h3 class="mt-0" style="position: absolute;top: 4%;left: 32%;">Facebook</h3>
                        </div>
                    <iframe style="border: medium none; visibility: visible;padding-right: 100px; width: 330px; height: 350px;" class="" src="http://www.facebook.com/v2.5/plugins/post.php?app_id=&amp;channel=http%3A%2F%2Fstaticxx.facebook.com%2Fconnect%2Fxd_arbiter.php%3Fversion%3D42%23cb%3Df3a1a20a440d022%26domain%3Dlocalhost%26origin%3Dhttp%253A%252F%252Flocalhost%252Ff155f7bcac485%26relation%3Dparent.parent&amp;container_width=297&amp;href=https%3A%2F%2Fwww.facebook.com%2F20531316728%2Fposts%2F10154009990506729%2F&amp;locale=en_US&amp;sdk=joey&amp;width=350" title="fb:post Facebook Social Plugin" scrolling="no" allowfullscreen="true" allowtransparency="true" name="f14fd6217ab7d6c" width="350px" frameborder="0" height="1000px"></iframe>
                </div>
                </div>
                <div class="col-sm-4">
                    <div class="bg_wht pad-15">
                    <div style="display: block;border-bottom: 1px solid pink;margin-bottom: 10px;">
                        <a href="#" style="padding-left: 4%;"><i class="fa fa-instagram fa-4x"></i></a>
                        <h3 class="mt-0" style="position: absolute;top: 4%;left: 37%;">Instagram</h3>
                        </div>
                    <iframe src="http://www.intagme.com/in/?h=Y29tcHV0ZXJ8c2x8MzM1fDJ8M3wwMDAwMDB8eWVzfDV8dW5kZWZpbmVkfHllcw==" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:350px; height: 350px" ></iframe> </div>
             </div>
                </div>
            </div>
        </div>
