...
<title>Field To Fork | Grand Mills B2B | Abu Dhabi UAE</title>
<!-- Bootstrap core CSS -->
...
<div class="clear"></div>
<div class="banner"><img src="images/slider/field-to-fork-02.jpg"><h1>From Field to Fork</h1></div>
<div class="clear pad-20"></div>

<div class="container">
	<div class="row">
    	<div class="col-sm-3"><img src="images/field2folk.png" class="img-responsive"></div>
        <div class="col-sm-3 pull-right">
        	<iframe src="https://www.youtube.com/embed/KWLzk-tGCew?autoplay=0&rel=0&enablejsapi=1&playerapiid=ytplayer&wmode=transparent" frameborder="0" allowfullscreen width="100%" height="175"></iframe>
        </div>
    </div>
    <div class="clear pad-10"></div>
	<div class="row">
    	<div class="col-lg-12 text-center"><img src="images/flour-odyssey.png" class="img-center"></div>
    </div>
</div>
