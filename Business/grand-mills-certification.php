...
<html lang="en">
    <head>
        ...
        <title>Gran Mills Certification | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class=" banner"><img src="images/slider/field-to-fork-02.jpg" class=" img-responsive"><h1>Beyond Quality</h1></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="bg_wht pad-30"  style="padding-bottom: 222px;">
                        <h3 class="mt-0">Grand Mills Certification</h3>
