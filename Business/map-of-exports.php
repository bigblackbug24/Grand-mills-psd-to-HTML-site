...
<html lang="en">
    <head>
        ...
        <title>Map Of Exports | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class="banner"><img src="images/slider/field-to-fork-02.jpg"><h1>Beyond Borders</h1></div>
        <div class="clear pad-20"></div>
        <div class="container">
            <div class="row">
                <div class="clear pad-20"></div>
                <div class="col-sm-12 text-center">
                    <h3 class="mt-0">Map of Exports</h3>
                    <img style=" margin: 0 auto;" src="images/slider/map.png" class="img-responsive">
                </div>
            </div>
        </div>
