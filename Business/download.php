...
<html lang="en">
    <head>
        ...
        <title>Brochure Download | Grand Mills B2B | Abu Dhabi</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class="banner"><img src="images/slider/grand-mills-brochrue.jpg" class="img-responsive"><h1>Media</h1></div>
        <div class="clear pad-50"></div>
        
        <div class="container">
            <div class="row">
                 <h3 class="mt-0 pad-5">Download Brochure</h3>
                <div class="col-sm-12">             
                        <img style="min-height:1050px;max-height: 1050px;width:100%;" src="images/slider/Download-Brochure-Media_02.jpg" class="img-responsive">  
                    </div>
                 <div class="clear pad-5"></div>
                </div>
            <div class="row">
                <div class="col-sm-12">
                    <a href="#"><img style="min-height:150px;max-height: 200px;width:100%;" src="images/slider/Download-Brochure-Media-image_01.jpg" class="img-responsive"></a>  
                </div>
            </div>
        </div>
        <div class="clear pad-50"></div>
