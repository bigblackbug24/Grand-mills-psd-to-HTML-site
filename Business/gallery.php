...
<html lang="en">
    <head>
        ...
        <title>Gallery | Grand Mills B2B | Abu Dhabi UAE</title>
        <!-- Bootstrap core CSS -->
...
<div class="clear"></div>
        ...
        <div class="banner"><img src="images/slider/grand-mills-media.jpg"><h1>Media</h1></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <img src="images/slider/media-01.jpg" class="img-center"><br><br>
                    <img src="images/slider/media-03.jpg" class="img-center">
                </div>
                 <div class="col-sm-6">
                     <h3 class="mt-0">&nbsp;</h3>
                    <img src="images/slider/media-02.jpg" class="img-center"><br><br>
                    <img src="images/slider/media-04.jpg" class="img-center">
                </div>
