...
<div class="clear"></div>
        <div class=" banner"><img src="images/slider/career.jpg" class=" img-responsive"><h1>Beyond Quality</h1></div>
        <div class="clear pad-20"></div>
        
         <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/slider/grains.jpg" class="img-responsive">
                    <div style="padding-bottom: 70px;" class="bg_wht pad-20">
