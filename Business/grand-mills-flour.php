...
<title>Grand Mills Flour | Grand Mills B2B | Abu Dhabi UAE</title>
<!-- Bootstrap core CSS -->
...
<div class="banner"><img src="images/slider/weat.jpg"><h1>Grand Mills Flour</h1></div>
<div class="clear pad-20"></div>

<div class="container">
	<div class="row">
    	<div class="col-sm-6">
        	<img src="images/slider/grand-mills-flour.jpg" class="img-responsive">
            <div class="bg_wht pad-20">
            	<h3 class="mt-0">Grand Mills Flour</h3>
                <p>Agthia’s flour products are marketed under the brand name Grand Mills. They reflect the slogan ‘Live Healthy’, which embodies the company’s commitment to food safety as well as healthy diet and lifestyle.</p>
                
                <p>At Grand Mills, we endeavor to grow our product range to meet the people’s changing tastes and needs; while keeping health at the core of what we do.</p>
                <br><br><br><br><br>
            </div>
            <div class="clear pad-15"></div>
        </div>
        <div class="col-sm-6">
        	<img src="images/slider/grand-mills.jpg" class="img-responsive">
            <div class="bg_wht pad-20">
            	<h3 class="mt-0">&nbsp;</h3>
                <p>Precise work is put behind our bags of flour, grain and animal feed that reaches homes, businesses and farms. The production process has been tried, tested and perfected through time. Grand Mills’ production units are equipped with the most advanced machinery that undergoes constant upgrades to meet and exceed international standards with all stages of production being fully computerized.
</p>
                
                <p>The business relies on the skills, diverse experience, unique expertise and unwavering deciation of our people to move the company steadily forward. Our flour products breathe life into Agthia’s vision every single time they perform their tasks according to global standards and in line with wholehearted living.</p>
